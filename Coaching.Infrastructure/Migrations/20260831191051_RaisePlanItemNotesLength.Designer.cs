...
namespace Coaching.Infrastructure.Migrations
{
    ...
    [Migration("20260831191051_RaisePlanItemNotesLength")]
    partial class RaisePlanItemNotesLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Coaching.Domain.Models.Templates.PlanItemPlacement", b =>
                {
                    ...
                    b.HasIndex("PlanId", "VenueId", "ItemId")
                        .IsUnique()
                        .HasFilter("\"ItemId\" IS NOT NULL");

                    b.HasIndex("PlanId", "VenueId", "StationItemId")
                        .IsUnique()
                        .HasFilter("\"StationItemId\" IS NOT NULL");
